#=*
* Check if CUDA v10.1 functions are wrapped properly.
*
...
println("cuThreadExchangeStreamCaptureMode(): ", cuda_error_name(cuThreadExchangeStreamCaptureMode(Ptr{CUstreamCaptureMode}(C_NULL))))
@test (cuThreadExchangeStreamCaptureMode(Ptr{CUstreamCaptureMode}(C_NULL)) == CUDA_ERROR_NOT_INITIALIZED)
...
println("cuStreamGetCaptureInfo(): ", cuda_error_name(cuStreamGetCaptureInfo(CUstream(C_NULL), Ptr{CUstreamCaptureStatus}(C_NULL), Ptr{cuuint64_t}(C_NULL))))
@test (cuStreamGetCaptureInfo(CUstream(C_NULL), Ptr{CUstreamCaptureStatus}(C_NULL), Ptr{cuuint64_t}(C_NULL)) == CUDA_ERROR_INVALID_VALUE)
...
println("cuGraphExecKernelNodeSetParams(): ", cuda_error_name(cuGraphExecKernelNodeSetParams(CUgraphExec(C_NULL), CUgraphNode(C_NULL), Ptr{CUDA_KERNEL_NODE_PARAMS}(C_NULL))))
@test (cuGraphExecKernelNodeSetParams(CUgraphExec(C_NULL), CUgraphNode(C_NULL), Ptr{CUDA_KERNEL_NODE_PARAMS}(C_NULL)) == CUDA_ERROR_NOT_INITIALIZED)
