#=*
* CUDA runtime API v10.0 definitions
*
...
const cudaErrorSystemNotReady               = cudaError_t(83)
const cudaErrorIllegalState                 = cudaError_t(84)
...
#=
In CUDA 10.0, 'cudaFuncAttributeMax' is 10 by enumerating from
...
#=
In CUDA 10.0, 'cudaGraphNodeTypeCount' is 6 by enumerating from
