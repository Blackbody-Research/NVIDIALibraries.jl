...
function cuLinkAddData(state::CUlinkState, jitype::CUjitInputType, data::Ptr{Cvoid}, size::Csize_t, name::Array{UInt8, 1}, numOptions::Cuint, options::Array{CUjit_option, 1}, optionValues::Array{Ptr{Cvoid}, 1})::CUresult
    return ccall((:cuLinkAddData, libcuda), CUresult, (CUlinkState, CUjitInputType, Ptr{Cvoid}, Csize_t, Ref{UInt8}, Cuint, Ref{CUjit_option}, Ref{Ptr{Cvoid}},), state, jitype, data, size, Base.cconvert(Ref{UInt8}, name), numOptions, Base.cconvert(Ref{CUjit_option}, options), Base.cconvert(Ref{Ptr{Cvoid}}, optionValues))
end

function cuLinkAddData(state::CUlinkState, jitype::CUjitInputType, data::Ptr{Cvoid}, size::Csize_t, name::Ptr{UInt8}, numOptions::Cuint, options::Ptr{CUjit_option}, optionValues::Ptr{Ptr{Cvoid}})::CUresult
    return ccall((:cuLinkAddData, libcuda), CUresult, (CUlinkState, CUjitInputType, Ptr{Cvoid}, Csize_t, Ptr{UInt8}, Cuint, Ptr{CUjit_option}, Ptr{Ptr{Cvoid}},), state, jitype, data, size, name, numOptions, options, optionValues)
end

# cuLinkAddFile() available since CUDA 5.5
function cuLinkAddFile(state::CUlinkState, jitype::CUjitInputType, path::Array{UInt8, 1}, numOptions::Cuint, options::Array{CUjit_option, 1}, optionValues::Array{Ptr{Cvoid}, 1})::CUresult
    return ccall((:cuLinkAddFile, libcuda), CUresult, (CUlinkState, CUjitInputType, Ref{UInt8}, Cuint, Ref{CUjit_option}, Ref{Ptr{Cvoid}},), state, jitype, Base.cconvert(Ref{UInt8}, path), numOptions, Base.cconvert(Ref{CUjit_option}, options), Base.cconvert(Ref{Ptr{Cvoid}}, optionValues))
end

function cuLinkAddFile(state::CUlinkState, jitype::CUjitInputType, path::Ptr{UInt8}, numOptions::Cuint, options::Ptr{CUjit_option}, optionValues::Ptr{Ptr{Cvoid}})::CUresult
    return ccall((:cuLinkAddFile, libcuda), CUresult, (CUlinkState, CUjitInputType, Ptr{UInt8}, Cuint, Ptr{CUjit_option}, Ptr{Ptr{Cvoid}},), state, jitype, path, numOptions, options, optionValues)
end
...
# cuMemcpyDtotD() available since CUDA 3.2
...
# cuMemsetD2D32() available since CUDA 3.2
...
# blockSizeToDynamicSMemSize should be a C-callable function or C_NULL
