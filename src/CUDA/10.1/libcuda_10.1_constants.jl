...
const CU_STREAM_MEM_OP_WAIT_VALUE_64       = CUstreamBatchMemOpType(4)
const CU_STREAM_MEM_OP_WRITE_VALUE_64      = CUstreamBatchMemOpType(5)
...
const CU_DEVICE_ATTRIBUTE_CAN_USE_STREAM_MEM_OPS                       = CUdevice_attribute(92)
const CU_DEVICE_ATTRIBUTE_CAN_USE_64_BIT_STREAM_MEM_OPS                = CUdevice_attribute(93)
const CU_DEVICE_ATTRIBUTE_CAN_USE_STREAM_WAIT_VALUE_NOR                = CUdevice_attribute(94)
...
#=
In CUDA 10.1, 'CU_DEVICE_ATTRIBUTE_MAX' is 102 after enumerating from
...
#=
In CUDA 10.1, 'CU_FUNC_ATTRIBUTE_MAX' is 10 by enumerating from
...
# CUshared_carveout can be negative
const CUshared_carveout = Cint

# possible CUshared_carveout values
const CU_SHAREDMEM_CARVEOUT_DEFAULT       = CUshared_carveout(-1)
const CU_SHAREDMEM_CARVEOUT_MAX_SHARED    = CUshared_carveout(100)
const CU_SHAREDMEM_CARVEOUT_MAX_L1        = CUshared_carveout(0)
...
#=
In CUDA 10.1, 'CU_JIT_NUM_OPTIONS' is 20 by enumerating from
...
const CU_TARGET_COMPUTE_72 = CUjit_target(72)       # < Compute device class 7.2
...
#=
In CUDA 10.1, 'CU_JIT_NUM_INPUT_TYPES' is 5 by enumerating from
...
#=
In CUDA 10.1, 'CU_LIMIT_MAX' is 6 by enumerating from
...
#=
In CUDA 10.1, 'CU_GRAPH_NODE_TYPE_COUNT' is 6 by enumerating from
...
# CUstreamCaptureMode available since CUDA 10.1
const CUstreamCaptureMode = Cuint

# possible CUstreamCaptureMode values
const CU_STREAM_CAPTURE_MODE_GLOBAL       = CUstreamCaptureMode(0)
const CU_STREAM_CAPTURE_MODE_THREAD_LOCAL = CUstreamCaptureMode(1)
...
const CUDA_ERROR_JIT_COMPILER_NOT_FOUND         = CUresult(221)
...
const CUDA_ERROR_COMPAT_NOT_SUPPORTED_ON_DEVICE = CUresult(804)
...
const CUDA_ERROR_STREAM_CAPTURE_WRONG_THREAD    = CUresult(908)
...
const CU_DEVICE_P2P_ATTRIBUTE_ACCESS_ACCESS_SUPPORTED       = CUdevice_P2PAttribute(0x04)
...
# CUDA_LAUNCH_PARAMS available since CUDA 9.0
struct CUDA_LAUNCH_PARAMS
    cuFunction::CUfunction  # 'function' is a julia keyword, we use `cuFunction` here
    gridDimX::Cuint
    gridDimY::Cuint
    gridDimZ::Cuint
    blockDimX::Cuint
...
Base.zero(::Type{CUDA_LAUNCH_PARAMS}) = CUDA_LAUNCH_PARAMS(CUfunction(0),
                                            Cuint(0),
                                            Cuint(0),
                                            Cuint(0),
                                            Cuint(0),
