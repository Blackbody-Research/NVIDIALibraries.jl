...
function cublasGetMathMode(handle::cublasHandle_t, mode::Array{cublasMath_t, 1})::cublasStatus_t
    return ccall((:cublasGetMathMode, libcublas), cublasStatus_t, (cublasHandle_t, Ref{cublasMath_t},), handle, Base.cconvert(Ref{cublasMath_t}, mode))
end

function cublasGetMathMode(handle::cublasHandle_t, mode::Ptr{cublasMath_t})::cublasStatus_t
    return ccall((:cublasGetMathMode, libcublas), cublasStatus_t, (cublasHandle_t, Ptr{cublasMath_t},), handle, mode)
end

function cublasSetMathMode(handle::cublasHandle_t, mode::cublasMath_t)::cublasStatus_t
    return ccall((:cublasSetMathMode, libcublas), cublasStatus_t, (cublasHandle_t, cublasMath_t,), handle, mode)
end

function cublasLoggerConfigure(logIsOn::Cint, logToStdOut::Cint, logToStdErr::Cint, logFileName::Array{UInt8, 1})::cublasStatus_t
    return ccall((:cublasLoggerConfigure, libcublas), cublasStatus_t, (Cint, Cint, Cint, Ref{UInt8},), logIsOn, logToStdOut, logToStdErr, Base.cconvert(Ref{UInt8}, logFileName))
end

function cublasLoggerConfigure(logIsOn::Cint, logToStdOut::Cint, logToStdErr::Cint, logFileName::Ptr{UInt8})::cublasStatus_t
    return ccall((:cublasLoggerConfigure, libcublas), cublasStatus_t, (Cint, Cint, Cint, Ptr{UInt8},), logIsOn, logToStdOut, logToStdErr, logFileName)
end

function cublasSetLoggerCallback(userCallback::cublasLogCallback)::cublasStatus_t
    return ccall((:cublasSetLoggerCallback, libcublas), cublasStatus_t, (cublasLogCallback,), userCallback)
end

function cublasGetLoggerCallback(userCallback::Array{cublasLogCallback, 1})::cublasStatus_t
    return ccall((:cublasGetLoggerCallback, libcublas), cublasStatus_t, (Ref{cublasLogCallback},), Base.cconvert(Ref{cublasLogCallback}, userCallback))
end

function cublasGetLoggerCallback(userCallback::Ptr{cublasLogCallback})::cublasStatus_t
    return ccall((:cublasGetLoggerCallback, libcublas), cublasStatus_t, (Ptr{cublasLogCallback},), userCallback)
end
...
function cublasCopyEx(handle::cublasHandle_t, n::Cint, x::Array{T, 1}, xType::cudaDataType, incx::Cint, y::Array{T, 1}, yType::cudaDataType, incy::Cint)::cublasStatus_t where {T <: AbstractFloat}
    return ccall((:cublasCopyEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ref{T}, cudaDataType, Cint, Ref{T}, cudaDataType, Cint,), handle, n, Base.cconvert(Ref{T}, x), xType, incx, Base.cconvert(Ref{T}, y), yType, incy)
end

function cublasCopyEx(handle::cublasHandle_t, n::Cint, x::Ptr{T}, xType::cudaDataType, incx::Cint, y::Ptr{T}, yType::cudaDataType, incy::Cint)::cublasStatus_t where {T <: AbstractFloat}
    return ccall((:cublasCopyEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Nothing}, cudaDataType, Cint,), handle, n, Ptr{Nothing}(x), xType, incx, Ptr{Nothing}(y), yType, incy)
end

function cublasCopyEx(handle::cublasHandle_t, n::Cint, x::Ptr{Nothing}, xType::cudaDataType, incx::Cint, y::Ptr{Nothing}, yType::cudaDataType, incy::Cint)::cublasStatus_t
    return ccall((:cublasCopyEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Nothing}, cudaDataType, Cint,), handle, n, x, xType, incx, y, yType, incy)
end
...
function cublasSwapEx(handle::cublasHandle_t, n::Cint, x::Array{T, 1}, xType::cudaDataType, incx::Cint, y::Array{T, 1}, yType::cudaDataType, incy::Cint)::cublasStatus_t where {T <: AbstractFloat}
    return ccall((:cublasSwapEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ref{T}, cudaDataType, Cint, Ref{T}, cudaDataType, Cint,), handle, n, Base.cconvert(Ref{T}, x), xType, incx, Base.cconvert(Ref{T}, y), yType, incy)
end

function cublasSwapEx(handle::cublasHandle_t, n::Cint, x::Ptr{T}, xType::cudaDataType, incx::Cint, y::Ptr{T}, yType::cudaDataType, incy::Cint)::cublasStatus_t where {T <: AbstractFloat}
    return ccall((:cublasSwapEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Nothing}, cudaDataType, Cint,), handle, n, Ptr{Nothing}(x), xType, incx, Ptr{Nothing}(y), yType, incy)
end

function cublasSwapEx(handle::cublasHandle_t, n::Cint, x::Ptr{Nothing}, xType::cudaDataType, incx::Cint, y::Ptr{Nothing}, yType::cudaDataType, incy::Cint)::cublasStatus_t
    return ccall((:cublasSwapEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Nothing}, cudaDataType, Cint,), handle, n, x, xType, incx, y, yType, incy)
end
...
function cublasIamaxEx(handle::cublasHandle_t, n::Cint, x::Array{T, 1}, xType::cudaDataType, incx::Cint, result::Array{Cint, 1})::cublasStatus_t where {T <: AbstractFloat}
    return ccall((:cublasIamaxEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ref{T}, cudaDataType, Cint, Ref{Cint},), handle, n, Base.cconvert(Ref{T}, x), xType, incx, Base.cconvert(Ref{Cint}, result))
end

function cublasIamaxEx(handle::cublasHandle_t, n::Cint, x::Ptr{T}, xType::cudaDataType, incx::Cint, result::Ptr{Cint})::cublasStatus_t where {T <: AbstractFloat}
    return ccall((:cublasIamaxEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Cint},), handle, n, Ptr{Nothing}(x), xType, incx, result)
end

function cublasIamaxEx(handle::cublasHandle_t, n::Cint, x::Ptr{Nothing}, xType::cudaDataType, incx::Cint, result::Ptr{Cint})::cublasStatus_t
    return ccall((:cublasIamaxEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Cint},), handle, n, x, xType, incx, result)
end
...
function cublasIaminEx(handle::cublasHandle_t, n::Cint, x::Array{T, 1}, xType::cudaDataType, incx::Cint, result::Array{Cint, 1})::cublasStatus_t where {T <: AbstractFloat}
    return ccall((:cublasIaminEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ref{T}, cudaDataType, Cint, Ref{Cint},), handle, n, Base.cconvert(Ref{T}, x), xType, incx, Base.cconvert(Ref{Cint}, result))
end

function cublasIaminEx(handle::cublasHandle_t, n::Cint, x::Ptr{T}, xType::cudaDataType, incx::Cint, result::Ptr{Cint})::cublasStatus_t where {T <: AbstractFloat}
    return ccall((:cublasIaminEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Cint},), handle, n, Ptr{Nothing}(x), xType, incx, result)
end

function cublasIaminEx(handle::cublasHandle_t, n::Cint, x::Ptr{Nothing}, xType::cudaDataType, incx::Cint, result::Ptr{Cint})::cublasStatus_t
    return ccall((:cublasIaminEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Cint},), handle, n, x, xType, incx, result)
end

function cublasAsumEx(handle::cublasHandle_t, n::Cint, x::Ptr{Nothing}, xType::cudaDataType, incx::Cint, result::Ptr{Nothing}, resultType::cudaDataType, executionType::cudaDataType)::cublasStatus_t
    return ccall((:cublasAsumEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Nothing}, cudaDataType, cudaDataType,), handle, n, x, xType, incx, result, resultType, executionType)
end
...
function cublasRotEx(handle::cublasHandle_t, n::Cint, x::Ptr{Nothing}, xType::cudaDataType, incx::Cint, y::Ptr{Nothing}, yType::cudaDataType, incy::Cint, c::Ptr{Nothing}, s::Ptr{Nothing}, csType::cudaDataType, executionType)::cublasStatus_t
    return ccall((:cublasRotEx, libcublas), cublasStatus_t, (cublasHandle_t, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Nothing}, cudaDataType, Cint, Ptr{Nothing}, Ptr{Nothing}, cudaDataType, cudaDataType,), handle, n, x, xType, incx, y, yType, incy, c, s, csType, executionType)
end
...
function cublasRotgEx(handle::cublasHandle_t, a::Ptr{Nothing}, b::Ptr{Nothing}, abType::cudaDataType, c::Ptr{Nothing}, s::Ptr{Nothing}, csType::cudaDataType, executionType::cudaDataType)::cublasStatus_t
    return ccall((:cublasRotgEx, libcublas), cublasStatus_t, (cublasHandle_t, Ptr{Nothing}, Ptr{Nothing}, cudaDataType, Ptr{Nothing}, Ptr{Nothing}, cudaDataType, cudaDataType,), handle, a, b, abType, c, s, csType, executionType)
end
...
function cublasRotmgEx(handle::cublasHandle_t, d1::Ptr{Nothing}, d1Type::cudaDataType, d2::Ptr{Nothing}, d2Type::cudaDataType, x1::Ptr{Nothing}, x1Type::cudaDataType, y1::Ptr{Nothing}, y1Type::cudaDataType, param::Ptr{Nothing}, paramType::cudaDataType, executionType::cudaDataType)::cublasStatus_t
    return ccall((:cublasRotmgEx, libcublas), cublasStatus_t, (cublasHandle_t, Ptr{Nothing}, cudaDataType, Ptr{Nothing}, cudaDataType, Ptr{Nothing}, cudaDataType, Ptr{Nothing}, cudaDataType, Ptr{Nothing}, cudaDataType, cudaDataType,), handle, d1, d1Type, d2, d2Type, x1, x1Type, y1, y1Type, param, paramType, executionType)
end
...
function cublasHgemmBatched(handle::cublasHandle_t, transa::cublasOperation_t, transb::cublasOperation_t, m::Cint, n::Cint, k::Cint, alpha::Array{__half, 1}, Aarray::Array{Ptr{__half}, 1}, lda::Cint, Barray::Array{Ptr{__half}, 1}, ldb::Cint, beta::Array{__half, 1}, Carray::Array{Ptr{__half}, 1}, ldc::Cint, batchCount::Cint)::cublasStatus_t
    return ccall((:cublasHgemmBatched, libcublas), cublasStatus_t, (cublasHandle_t, cublasOperation_t, cublasOperation_t, Cint, Cint, Cint, Ref{__half}, Ref{Ptr{__half}}, Cint, Ref{Ptr{__half}}, Cint, Ref{__half}, Ref{Ptr{__half}}, Cint, Cint,), handle, transa, transb, m, n, k, Base.cconvert(Ref{__half}, alpha), Base.cconvert(Ref{Ptr{__half}}, Aarray), lda, Base.cconvert(Ref{Ptr{__half}}, Barray), ldb, Base.cconvert(Ref{__half}, beta), Base.cconvert(Ref{Ptr{__half}}, Carray), ldc, batchCount)
end

function cublasHgemmBatched(handle::cublasHandle_t, transa::cublasOperation_t, transb::cublasOperation_t, m::Cint, n::Cint, k::Cint, alpha::Ptr{__half}, Aarray::Ptr{Ptr{__half}}, lda::Cint, Barray::Ptr{Ptr{__half}}, ldb::Cint, beta::Ptr{__half}, Carray::Ptr{Ptr{__half}}, ldc::Cint, batchCount::Cint)::cublasStatus_t
    return ccall((:cublasHgemmBatched, libcublas), cublasStatus_t, (cublasHandle_t, cublasOperation_t, cublasOperation_t, Cint, Cint, Cint, Ptr{__half}, Ptr{Ptr{__half}}, Cint, Ptr{Ptr{__half}}, Cint, Ptr{__half}, Ptr{Ptr{__half}}, Cint, Cint,), handle, transa, transb, m, n, k, alpha, Aarray, lda, Barray, ldb, beta, Carray, ldc, batchCount)
end
...
function cublasGemmBatchedEx(handle::cublasHandle_t, transa::cublasOperation_t, transb::cublasOperation_t, m::Cint, n::Cint, k::Cint, alpha::Ptr{Cvoid}, Aarray::Array{Ptr{Cvoid}, 1}, Atype::cudaDataType, lda::Cint, Barray::Array{Ptr{Cvoid}, 1}, Btype::cudaDataType, ldb::Cint, beta::Ptr{Cvoid}, Carray::Array{Ptr{Cvoid}, 1}, Ctype::cudaDataType, ldc::Cint, batchCount::Cint, computeType::cudaDataType, algo::cublasGemmAlgo_t)::cublasStatus_t
    return ccall((:cublasGemmBatchedEx, libcublas), cublasStatus_t, (cublasHandle_t, cublasOperation_t, cublasOperation_t, Cint, Cint, Cint, Ptr{Cvoid}, Ref{Ptr{Cvoid}}, cudaDataType, Cint, Ref{Ptr{Cvoid}}, cudaDataType, Cint, Ptr{Cvoid}, Ref{Ptr{Cvoid}}, cudaDataType, Cint, Cint, cudaDataType, cublasGemmAlgo_t,), handle, transa, transb, m, n, k, alpha, Base.cconvert(Ref{Ptr{Cvoid}}, Aarray), Atype, lda, Base.cconvert(Ref{Ptr{Cvoid}}, Barray), Btype, ldb, beta, Base.cconvert(Ref{Ptr{Cvoid}}, Carray), Ctype, ldc, batchCount, computeType, algo)
end

function cublasGemmBatchedEx(handle::cublasHandle_t, transa::cublasOperation_t, transb::cublasOperation_t, m::Cint, n::Cint, k::Cint, alpha::Ptr{Cvoid}, Aarray::Ptr{Ptr{Cvoid}}, Atype::cudaDataType, lda::Cint, Barray::Ptr{Ptr{Cvoid}}, Btype::cudaDataType, ldb::Cint, beta::Ptr{Cvoid}, Carray::Ptr{Ptr{Cvoid}}, Ctype::cudaDataType, ldc::Cint, batchCount::Cint, computeType::cudaDataType, algo::cublasGemmAlgo_t)::cublasStatus_t
    return ccall((:cublasGemmBatchedEx, libcublas), cublasStatus_t, (cublasHandle_t, cublasOperation_t, cublasOperation_t, Cint, Cint, Cint, Ptr{Cvoid}, Ptr{Ptr{Cvoid}}, cudaDataType, Cint, Ptr{Ptr{Cvoid}}, cudaDataType, Cint, Ptr{Cvoid}, Ptr{Ptr{Cvoid}}, cudaDataType, Cint, Cint, cudaDataType, cublasGemmAlgo_t,), handle, transa, transb, m, n, k, alpha, Aarray, Atype, lda, Barray, Btype, ldb, beta, Carray, Ctype, ldc, batchCount, computeType, algo)
end

function cublasGemmStridedBatchedEx(handle::cublasHandle_t, transa::cublasOperation_t, transb::cublasOperation_t, m::Cint, n::Cint, k::Cint, alpha::Ptr{Cvoid}, A::Ptr{Cvoid}, Atype::cudaDataType, lda::Cint, strideA::Clonglong, B::Ptr{Cvoid}, Btype::cudaDataType, ldb::Cint, strideB::Clonglong, beta::Ptr{Cvoid}, C::Ptr{Cvoid}, Ctype::cudaDataType, ldc::Cint, strideC::Clonglong, batchCount::Cint, computeType::cudaDataType, algo::cublasGemmAlgo_t)::cublasStatus_t
    return ccall((:cublasGemmStridedBatchedEx, libcublas), cublasStatus_t, (cublasHandle_t, cublasOperation_t, cublasOperation_t, Cint, Cint, Cint, Ptr{Cvoid}, Ptr{Cvoid}, cudaDataType, Cint, Clonglong, Ptr{Cvoid}, cudaDataType, Cint, Clonglong, Ptr{Cvoid}, Ptr{Cvoid}, cudaDataType, Cint, Clonglong, Cint, cudaDataType, cublasGemmAlgo_t,), handle, transa, transb, m, n, k, alpha, A, Atype, lda, strideA, B, Btype, ldb, strideB, beta, C, Ctype, ldc, strideC, batchCount, computeType, algo)
end
