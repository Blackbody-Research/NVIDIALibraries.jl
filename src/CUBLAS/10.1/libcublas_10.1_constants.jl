...
const CUBLAS_FILL_MODE_FULL     = cublasFillMode_t(2)
...
const CUBLAS_OP_HERMITAN = cublasOperation_t(2)  # synonym if CUBLAS_OP_C
const CUBLAS_OP_CONJG    = cublasOperation_t(3)  # conjugate
...
const CUBLAS_GEMM_ALGO18            = cublasGemmAlgo_t(18)
const CUBLAS_GEMM_ALGO19            = cublasGemmAlgo_t(19)
const CUBLAS_GEMM_ALGO20            = cublasGemmAlgo_t(20)
const CUBLAS_GEMM_ALGO21            = cublasGemmAlgo_t(21)
const CUBLAS_GEMM_ALGO22            = cublasGemmAlgo_t(22)
const CUBLAS_GEMM_ALGO23            = cublasGemmAlgo_t(23)
...
const CUBLAS_GEMM_ALGO5_TENSOR_OP   = cublasGemmAlgo_t(105)
const CUBLAS_GEMM_ALGO6_TENSOR_OP   = cublasGemmAlgo_t(106)
const CUBLAS_GEMM_ALGO7_TENSOR_OP   = cublasGemmAlgo_t(107)
const CUBLAS_GEMM_ALGO8_TENSOR_OP   = cublasGemmAlgo_t(108)
const CUBLAS_GEMM_ALGO9_TENSOR_OP   = cublasGemmAlgo_t(109)
const CUBLAS_GEMM_ALGO10_TENSOR_OP  = cublasGemmAlgo_t(110)
const CUBLAS_GEMM_ALGO11_TENSOR_OP  = cublasGemmAlgo_t(111)
const CUBLAS_GEMM_ALGO12_TENSOR_OP  = cublasGemmAlgo_t(112)
const CUBLAS_GEMM_ALGO13_TENSOR_OP  = cublasGemmAlgo_t(113)
const CUBLAS_GEMM_ALGO14_TENSOR_OP  = cublasGemmAlgo_t(114)
const CUBLAS_GEMM_ALGO15_TENSOR_OP  = cublasGemmAlgo_t(115)
...
# type association for CUBLAS logging callback function
const cublasLogCallback = Ptr{Nothing}
